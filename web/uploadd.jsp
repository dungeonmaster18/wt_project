<%-- 
    Document   : uploadd
    Created on : Nov 7, 2016, 10:40:46 PM
    Author     : umesh
--%>
        ...
        <div id="wrapper" style="padding-bottom: 300px;background-image: url(img/index.jpg);background-repeat: no-repeat;background-attachment: fixed; background-size: 100% 100%; background-position: center;">
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="padding-left: 200px ; padding-top: 20px;">
                    ...
                    <a href="profile_donor.jsp" style="color: black;">profile</a><br>
                    <a href="resetdpassword.jsp" style="color: black;">Reset password</a>
                </div>
            </div>
            
            
            <div style="padding-top: 200px; margin-left: 650px; ">
                <form action="FileUploadDServlet.do" method="post" enctype="multipart/form-data">
