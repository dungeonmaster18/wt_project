<%-- 
    Document   : welcome
    Created on : Oct 18, 2016, 10:05:05 PM
    Author     : umesh
--%>
...
<html>
    ...
    <body>
        ...
        <div id="wrapper" style="padding-bottom: 330px; padding-top: 200px;background-image: url(img/index.jpg);background-repeat: no-repeat;background-attachment: fixed; background-size: 100% 100%; background-position: center;">
            ...
            <h1 class="alert alert-success" style="padding-left: 300px;"><strong>Success!</strong> You have been Register,Click here to login <a href="login.jsp ">(Login)</a></h1>
