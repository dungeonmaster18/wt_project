<%-- 
    Document   : error
    Created on : Oct 27, 2016, 3:57:44 PM
    Author     : umesh
--%>
...
<html>
    ...
    <body>
        ...
        <div id="wrapper" style="padding-bottom: 330px; padding-top: 200px;background-image: url(img/index.jpg);background-repeat: no-repeat;background-attachment: fixed; background-size: 100% 100%; background-position: center;">

            <h1 class="alert alert-danger" style="padding-left: 300px;"><strong>Oops!</strong> It seems your session has been expired,Click here to login <a href="login.jsp ">(Login)</a></h1>
