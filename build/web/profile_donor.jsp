<%-- 
    Document   : profile
    Created on : Oct 18, 2016, 10:48:30 PM
    Author     : umesh
--%>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card card-outline-danger" style="width: 300px">
                        <img class="card-img-top" src="<%=img%>" alt="img/img_avatar2.png" style="width: 300px;">
                ...
                <div class="col-md-4" style="padding-left: 200px ; padding-top: 20px;">
                    ...
                    <a href="resetdpassword.jsp" style="color: black;">change password</a><br>
                    <a href="uploadd.jsp" style="color: black;">Upload profile</a>
                </div>
            </div>
