<%-- 
    Document   : register
    Created on : Oct 18, 2016, 10:08:11 PM
    Author     : umesh
--%>
    ...
    <body>
        ...
        <div class="row" style="padding-bottom: 300px; padding-top: 200px;background-image: url(img/index.jpg);background-repeat: no-repeat;background-attachment: fixed; background-size: 100% 100%; background-position: center;">
            <div class="col-sm-6" style="padding-left: 400px">
                <div class="card" >
                    <h3 class="card-header text-xs-center" style="background-color: rgba(0,158,227, 0.78); " >Register As</h3>
                    <div class="card-block text-xs-center">
                        <h4 class="card-title">Donor</h4><br>
                        <a href="formd.jsp" class="btn btn-effect btn-blue">Register</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3" style="">
                <div class="card" >
                    ...
                    <div class="card-block text-xs-center">
                        ...
                        <a href="formh.jsp" class="btn btn-effect btn-blue" >Register</a>
                    </div>
                </div>
            </div>
        </div>
