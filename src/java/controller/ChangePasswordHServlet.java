 ...
 * @author umesh
 */
public class ChangePasswordHServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean b = ldao.checkHPassword(f);
            ...
            if (b) {
                ldao.changeHPassword(f);
                s.sendEmail(email, message,"For Verifiaction");
                response.sendRedirect("profile_hospital.jsp");
            } else {
                response.sendRedirect("resethpassword.jsp");
            }
        }
    }
